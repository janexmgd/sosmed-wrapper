    ...
    try {
      ...
      const res = await client({
        ...
        headers: {
          'sdk-version': '2',
          'user-agent':
            'com.zhiliaoapp.musically/2022307030 (Linux; U; Android 10.0.0; en; Samsung; Build/OPR6.1674146527.017;tt-ok/3.10.0.2)',
          ...
          cookie:
            'install_id=7187123175168165678; store-country-code=us; store-country-code-src=did; store-idc=useast5; ttreq=1$1b75e317092d0c7549eb4cc58df50fae2a7a8664',
